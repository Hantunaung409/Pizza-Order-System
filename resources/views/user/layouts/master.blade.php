                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <div class="dropdown d-inline mr-4">
                                ...
                                <ul class="dropdown-menu me-5">
                                    <li><a class="dropdown-item my-2" href="{{ route('user@changeProfilePage') }}"><i class="fa-solid fa-user"></i>Account</a></li>
                                    ...
                                    <li>
                                        <span class="dropdown-item my-2">
                                            <form action="{{ route('logout') }}" method="POST" class="d-inline">
                                                @csrf
                                                <button class="btn btn-dark text-white ml-3">Logout<i
