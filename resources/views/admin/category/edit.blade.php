                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('category@update') }}" method="post" novalidate="novalidate">
                            ...
                            <div class="form-group">
                                ...
                                <input id="categoryName" name="categoryName" type="text" class="form-control @error('categoryName')
                                is-invalid
                                @enderror" aria-required="true" aria-invalid="false" value=" {{ old('categoryName',$category->name) }}">
                            ...
                            <div>
                                <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                    <span id="payment-button-amount"><i class="fa-solid fa-pen-to-square"></i>Update</span>
